...
def build_output_json(result: dict, site_input: dict) -> dict:
    ...
    output = {
        ...
        "_meta": {
            ...
            "PPRI_nom":  {"description": "Nom du Plan de Prévention des Risques d'Inondation applicable", "unite": "—", "source": "WMS Géorisques BRGM"},
            ...
            "PMHGF_m":   {"description": "Préconisation de Mise Hors Gel de la Fondation — profondeur minimale d'enfouissement des fondations superficielles pour éviter les effets du gel. Si l'altitude A du site est inférieure ou égale à 150 m, PMHGF = H0 (valeur de base de la zone de gel). Si A > 150 m, PMHGF = H0 + (A − 150) / 4000. H0 dépend de la zone climatique : Zone 1 (gel faible) = 0.50 m, Zone 2 (gel modéré) = 0.60 m, Zone 3 (gel sévère) = 0.80 m, Zone 4 (gel très sévère) = 0.90 m.", "unite": "m", "norme": "NF P 94-261 / DTU 13.1", "formule": "Si A <= 150m : PMHGF = H0 ; Si A > 150m : PMHGF = H0 + (A-150)/4000"},
            "PMHGF_cm":  {"description": "Préconisation de Mise Hors Gel de la Fondation (même calcul que PMHGF_m, exprimé en centimètres)", "unite": "cm", "norme": "NF P 94-261 / DTU 13.1"},
            ...
            "ouvrages": {
                "_description": "Liste des ouvrages BSS trouvés dans l'emprise",
                "code_bss":  {"description": "Identifiant national BSS de l'ouvrage (BRGM)", "unite": "—", "format": "XXXXX/XXXX"},
                "COM":       {"description": "Commune de localisation de l'ouvrage", "unite": "—"},
                "BDCE":      {"description": "Bassin versant DCE (Directive Cadre sur l'Eau)", "unite": "—"},
                "DOuvPC":    {"description": "Distance entre l'ouvrage et le point ciblé", "unite": "m"},
                "NInv":      {"description": "Nature de l'investigation (forage, sondage, piézomètre, puits…)", "unite": "—"},
                "PIOuv":     {"description": "Profondeur d'investigation de l'ouvrage", "unite": "m"},
                "PeS":       {"description": "Niveau d'eau mesuré (profondeur sous le sol)", "unite": "m"},
                "AltOuv":    {"description": "Altitude NGF de l'ouvrage (tête de forage)", "unite": "m NGF"},
                "NDAOuv":    {"description": "Nombre de documents associés à l'ouvrage (scans InfoTerre)", "unite": "u"},
                "NCALOuv":   {"description": "Nombre de couches du log géologique numérique", "unite": "u"},
                "aquifere":  {"description": "Nom de l'aquifère capté par l'ouvrage", "unite": "—"},
                "lat":       {"description": "Latitude de l'ouvrage (WGS84)", "unite": "degrés décimaux"},
